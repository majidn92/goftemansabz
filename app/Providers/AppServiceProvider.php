...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // commented by majid molaea
        // $breaking_news = DB::table('posts')->where('status', 1)->where('visibility', 1)->where('breaking', 1)->orderBy('breaking_order', 'asc')->get();
        // view()->share('breaking_news', $breaking_news);
        // dd($breaking_newss);
    }
}
