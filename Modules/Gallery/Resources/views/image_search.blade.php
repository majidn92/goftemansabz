                                        ...
                                        <tr id="row_{{ $item->id }}">
                                            ...
                                            <td>
                                                <div class="post-image">
                                                    ...
                                                    @endif
                                                    @if(@$item->is_cover)
                                                        <span class="album-cover">{{__('album_cover')}}</span>
                                                    @endif
                                                </div> {{ $item->title }}
                                            </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu options-dropdown">
                                                            @if(Sentinel::getUser()->hasAccess(['album_write']) and $item->album_id !='')
                                                                <li>
                                                                    @if($item->is_cover!=1)
                                                                        <a href="javascript:void(0)"
                                                                           onclick="set_cover('{{ $item->id }}')">
                                                                            <i class="fa fa-plus option-icon"></i>{{ __('set_as_cover') }}
                                                                        </a>
                                                                    @endif
                                                                </li>
                                                            @endif
