                                    ...
                                    <tr id="row_{{ $item->id }}">
                                        ...
                                        <td>
                                            <div class="post-image">
                                                ...
                                                <img src=" {{basePath($item)}}/{{ $result }} " data-src="{{basePath($item)}}/{{ $result }}" alt="image" class="img-responsive img-thumbnail lazyloaded">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('gallery_images','{{ $item->id }}')"><i class="fa fa-trash option-icon"></i>{{ __('delete') }}
                                                        </a>
                                                    </li>
                                                    @endif
                                                </ul>
