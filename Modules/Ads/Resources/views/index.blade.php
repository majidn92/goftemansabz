                                            ...
                                            <td>
                                                @if(@$ad->ad_type == 'image')
                                                    @if(isFileExist(@$ad->adImage, $result = @$ad->adImage->thumbnail))
                                                        <img src="{{basePath($ad->adImage)}}/{{ $result }}" data-src="{{basePath($ad->adImage)}}/{{ $result }}" alt="{{ $ad->ad_name }}" id="image_preview"  width="64" height="64" alt="image" class="img-responsive img-thumbnail">
                                                    @else
