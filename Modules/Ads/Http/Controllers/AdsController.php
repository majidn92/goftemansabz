...
class AdsController extends Controller
{
    ...
    public function create_side()
    {
        ...
        return view('ads::side.ads_create',compact('sections'));
    }
    ...
    public function edit_side($id)
    {
        ...
        $sections = \DB::table('sections')->get();
        return view('ads::side/ads_edit', compact('ad','sections'));
    }
    ...
    {
        $ad     = AdCenter::where('id', $id)->first();
        return view('ads::center/ads_edit', compact('ad'));
    }
