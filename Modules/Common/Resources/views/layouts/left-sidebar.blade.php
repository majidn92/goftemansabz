                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link @yield('section')" href="#" data-toggle="collapse" @yield('section-aria-expanded', 'aria-expanded=false') data-target="#submenu-9" aria-controls="submenu-9">
                            <i class="fas fa-fw fa-th-list"></i>بخش ها و صنایع
                        </a>
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link @yield('section-index')" href="{{ url('setting/sections') }}">
                                        <i class="fab fa-fw fa-buysellads"></i>بخش ها و صنایع
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @yield('section-ads')" href="#">
                                        <i class="fab fa-fw fa-buysellads"></i>تبلیغات
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    @if (Sentinel::getUser()->hasAccess(['album_read']) || Sentinel::getUser()->hasAccess(['album_write']) || Sentinel::getUser()->hasAccess(['album_delete']))
                        <li class="nav-item">
                            <a class="nav-link @yield('video-gallery')" href="#" data-toggle="collapse" @yield('video-gallery-aria-expanded', 'aria-expanded=false') data-target="#submenu-500" aria-controls="submenu-500">
                                <i class="fas fa-fw fa-image"></i>گالری ویدئو
                            </a>
                            <div id="submenu-500" class="collapse submenu @yield('video-gallery-show')">
                                <ul class="nav flex-column">
                                    @if (Sentinel::getUser()->hasAccess(['album_read']) || Sentinel::getUser()->hasAccess(['album_delete']))
                                        <li class="nav-item">
                                            <a class="nav-link @yield('all-videos-active')" href="{{ route('videos') }}">
                                                ویدئوها
                                            </a>
                                        </li>
                                    @endif
                                    @if (Sentinel::getUser()->hasAccess(['album_read']) || Sentinel::getUser()->hasAccess(['album_write']) || Sentinel::getUser()->hasAccess(['album_delete']))
                                        <li class="nav-item">
                                            <a class="nav-link @yield('albums-active')" href="{{ route('video-albums') }}">
                                                {{ __('albums') }}
                                            </a>
                                        </li>
                                    @endif
                    ...
                    @if (Sentinel::getUser()->hasAccess(['menu_read']) || Sentinel::getUser()->hasAccess(['menu_write']) || Sentinel::getUser()->hasAccess(['menu_delete']) || Sentinel::getUser()->hasAccess(['menu_item_read']) || Sentinel::getUser()->hasAccess(['menu_item_write']) || Sentinel::getUser()->hasAccess(['menu_item_delete']) || Sentinel::getUser()->hasAccess(['theme_section_read']) || Sentinel::getUser()->hasAccess(['theme_section_write']) || Sentinel::getUser()->hasAccess(['theme_section_delete']))
                        <li class="nav-item">
                    ...
                    @if (Sentinel::getUser()->hasAccess(['theme_section_read']) || Sentinel::getUser()->hasAccess(['theme_section_write']) || Sentinel::getUser()->hasAccess(['theme_section_delete']))
                        <li class="nav-item">
