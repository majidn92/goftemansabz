                                    ...
                                    <div class="tab-pane fade show active" id="general_settings" role="tabpanel">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="latest_ipa_version"
                                                       class="col-form-label">{{ __('latest_ipa_version') }}</label>
                                                <input id="latest_ipa_version" class="form-control" name="latest_ipa_version"
                                                       value="{{ settingHelper('latest_ipa_version') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="latest_ipa_code"
                                                       class="col-latest_ipa_code-label">{{ __('latest_ipa_code') }}</label>
                                                <input id="latest_ipa_code" class="form-control" name="latest_ipa_code"
                                                       value="{{ settingHelper('latest_ipa_code') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="ipa_file_url"
                                                       class="col-form-label">{{ __('ipa_file_url') }}</label>
                                                <input id="ipa_file_url" class="form-control" name="ipa_file_url"
                                                       value="{{ settingHelper('ipa_file_url') }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                                <label for="whats_new_on_latest_ipa"
                                                       class="col-form-label">{{ __('whats_new_on_latest_ipa') }}</label>
                                                <textarea name="whats_new_on_latest_ipa" id="whats_new_on_latest_ipa"
                                                          class="form-control">{{ settingHelper('whats_new_on_latest_ipa') }}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ios_update_skipable_status" id="visibility_show"
                                                           value="true"
                                                           {{ settingHelper('ios_update_skipable_status') == 'true'? 'checked':"" }} class="custom-control-input">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ios_update_skipable_status" id="visibility_hide"
                                                           value="false"
                                                           class="custom-control-input" {{ settingHelper('ios_update_skipable_status') == 'false'? 'checked':"" }}>
                                                ...
                                                <div class="col-12 m-t-20">
                                                    <div class="form-group form-float form-group-sm text-right">
                                                        <button type="submit" name="status"
                                                                ...
                                                                class="m-r-10 mdi mdi-content-save-all"></i>{{ __('save') }}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
