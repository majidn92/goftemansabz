                                    ...
                                    <tbody>
                                        ...
                                        <tr id="row_{{ $post->id }}">
                                            ...
                                            <td class="td-post-sp">
                                                ...
                                                <label class="label bg-aqua label-table">{{ __('recommended') }}</label>
                                                @endif
                                                @if($post->editor_picks==1)
                                                <label class="label bg-success label-table">{{ __('editor_picks') }}</label>
                                                @endif
                                                @if($post->slider==1)
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu options-dropdown">
                                                        ...
                                                        <li>
                                                            ...
                                                            @if($post->recommended==1)
                                                            <a href="javascript:void(0)" onclick="remove_post_form('index','recommended','{{ $post->id }}')" name="option" class="btn-list-button">
                                                                <i class="fa fa-minus option-icon"></i>{{ __('recommended') }}
                                                            </a>
                                                            ...
                                                            @else
                                                            <a href="javascript:void(0)" onclick="add_post_to('recommended','{{ $post->id }}')" name="option" class="btn-list-button">
                                                                <i class="fa fa-plus option-icon"></i>{{ __('recommended') }}
                                                            </a>
                                                            @endif
                                                        </li>
                                                        <li>
                                                            ...
                                                            @if($post->editor_picks==1)
                                                            <a href="javascript:void(0)" onclick="remove_post_form('index','editor_picks','{{ $post->id }}')" name="option" class="btn-list-button">
                                                                <i class="fa fa-minus option-icon"></i>{{ __('editor_picks') }}
                                                            </a>
                                                            {{-- <a href="{{ route('remove-form',['feature'=>'recommended','post_id'=>$post->id]) }}" name="option" class="btn-list-button">
                                                                <i class="fa fa-minus option-icon"></i>{{ __('recommend') }} </a> --}}
                                                            @else
                                                            <a href="javascript:void(0)" onclick="add_post_to('editor_picks','{{ $post->id }}')" name="option" class="btn-list-button">
