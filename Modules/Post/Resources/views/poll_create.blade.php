                ...
                <div class="add-new-page  bg-white p-20 m-b-20">
                    <div class="add-new-header clearfix">
                        <div class="row">
                            ...
                            <div class="col-6 text-left">
                                <a href="{{ route('polls') }}" class="btn btn-primary btn-add-new btn-sm"><i class="fas fa-arrow-left"></i>
                                    {{ __('back_to_polls') }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="question" required id="poll-question" class="form-control">{{old('question')}}</textarea>
                        </div>
                    </div>
                    <div class="row m-0">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                <label class="input-group-text" for="start_date"><i class="fa fa-calendar-alt"></i></label>
                                <input type="text" class="form-control example1" id="start_date" name="start_date" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <label for="end_date">{{ __('end_date') }}*</label>
                            <div class="input-group">
                                <label class="input-group-text" for="end_date"><i class="fa fa-calendar-alt"></i></label>
                                <input type="text" class="form-control example1" id="end_date" name="end_date" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row p-l-15">
                        ...
                        <div class="col-sm-12">
                            <div class="row poll-option-1" id="1">
                                <div class="col-11">
                                    <div class="form-group">
                                        <label for="option" class="col-form-label">گزینه های پاسخ نظرسنجی*</label>
                                        <input id="option" name="option[]" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-1">
                                    <button type="button" class="btn btn-primary float-right m-t-35" onclick="addRowFeature(1);">
                    ...
                    <div class="row p-l-15">
                        ...
                        <div class="col-3 col-md-2">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="auth_required" id="for_all_user" value="1" checked="" class="custom-control-input">
                                <span class="custom-control-label">{{ __('yes') }}</span>
                            </label>
                        </div>
                        <div class="col-3 col-md-2">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="auth_required" id="only_register_user" value="0" class="custom-control-input">
                    ...
                    <div class="row p-l-15">
                        ...
                        <div class="col-3 col-md-2">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="status" id="poll_status_actvie" value="1" checked="" class="custom-control-input">
                                <span class="custom-control-label">{{ __('active') }}</span>
                            </label>
                        </div>
                        <div class="col-3 col-md-2">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="status" id="poll_status_inactvie" value="0" class="custom-control-input">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group form-float form-group-sm">
                                <button type="submit" class="btn btn-primary float-right m-t-20"><i class="m-l-10 mdi mdi-plus"></i>{{ __('add_poll') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
