                                ...
                                <div class="row p-l-15">
                                    <div class="col-12 col-md-4">
                                        <div class="form-title">
                                            <label for="is_featured">حالت ویژه</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3 col-md-2">
                                        <label class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <input type="radio" name="is_featured" id="visibility_hide" value="0" class="custom-control-input" data-parsley-multiple="visibility" checked >
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 m-t-20">
                                    <div class="form-group form-float form-group-sm text-right">
                                        <button type="submit" name="btnsubmit" class="btn btn-primary pull-right"><i class="m-l-10 mdi mdi-plus"></i>{{ __('add_category') }}</button>
                                    </div>
                                </div>
                            </div>
