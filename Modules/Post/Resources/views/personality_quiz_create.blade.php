                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="row p-l-15">
                                    <div class="col-12">
                                        ...
                                        <textarea name="content" value="{{ old('content') }}" id="post_content" cols="30" rows="5"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="content-area">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div id="quiz_result_container" class="quiz_result_container">
                                        ...
                                        <div id="panel_quiz_result_{{ $result_unique_id }}" class="panel panel-default panel-quiz-result" data-result-id="{{ $result_unique_id }}">
                                            <div class="panel panel-default mt-2 bg-white">
                                                <div class="panel-heading" role="tab" id="heading_" {{ $result_unique_id }}>
                                                    <h4 class="panel-title d-flex">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_{{ $result_unique_id }}" aria-expanded="true" aria-controls="collapse_{{ $result_unique_id }}">
                                                            #<span id="result_number_{{ $result_unique_id }}">1</span> <span id="result_{{ $result_unique_id }}"></span>
                                                        </a>
                                                        <div class="text-right">
                                                            <button type="button" class="btn btn-default" onclick="delete_quiz_result('{{ $result_unique_id }}')">
                                                                <i class="fa fa-trash"></i></button>
                                                        </div>
                                                    </h4>
                                                </div>
                                                <div id="collapse_{{ $result_unique_id }}" class="panel-collapse in collapse show" role="tabpanel" aria-labelledby="heading_{{ $result_unique_id }}" style="">
                                                    <div class="panel-body bg-white">

                                                        <div class="col-12 col-lg-12">
                                                            <div class="col-sm-12 pr-0">
                                                                <div class="form-group">
                                                                    <label for="result_input"><b>{{ __('result') }}</b></label>
                                                                    <input type="text" id="result_input" required class="form-control input-result-text" data-result-id="{{ $result_unique_id }}" data-is-update="0" name="result_title[]" placeholder="{{ __('result') }}" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-lg-12">
                                                            <div class="row">
                                                                <div class="col-sm-3 ">
                                                                    <div class="result-image">
                                                                        <div class="form-group">
                                                                            <!-- Large modal -->
                                                                            <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal ml-3" data-id="1" data-toggle="modal" data-result-id="{{ $result_unique_id }}" data-target=".image-modal-lg">{{ __('add_image') }}</button>
                                                                            <input id="image_id_result_{{ $result_unique_id }}" name="result_image[]" type="hidden" class="form-control image_id">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="form-group text-center">
                                                                                <img src="{{ static_asset('default-image/default-100x100.png') }} " id="image_preview_result_{{ $result_unique_id }}" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <div class="form-group">
                                                                        <label for="result_content" class="col-form-label pt-0">{{ __('content') }}
                                                                        </label>
                                                                        <textarea name="result_content[]" class="result-content" id="result_content"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row m-3">
                                        <div class="col-sm-12 text-center">
                                            <button type="button" id="btn_add_quiz_result" data-result-number="1" class="btn btn-md btn-primary btn-add-post-item">
                                                <i class="fa fa-plus ml-1"></i>{{ __('add_result') }}
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="content-area">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div id="quiz_questions_container" class="quiz_questions_container">
                                        ...
                                        <div id="panel_quiz_question_{{ $unique_id }}" class="panel panel-default panel-quiz-question" data-question-id="{{ $unique_id }}" data-quiz-type="trivia-quiz">
                                            <div class="panel panel-default mt-2 bg-white">
                                                <div class="panel-heading" role="tab" id="headingOne">
                                                    <h4 class="panel-title d-flex">
                                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse_{{ $unique_id }}" aria-expanded="true" aria-controls="collapse_{{ $unique_id }}">
                                                            #<span id="question_number_{{ $unique_id }}">1</span> <span id="question_{{ $unique_id }}"></span>
                                                        </a>
                                                        <div class="text-right">
                                                            <button type="button" class="btn btn-default" onclick="delete_quiz_question('{{ $unique_id }}')">
                                                                <i class="fa fa-trash"></i></button>
                                                        </div>
                                                    </h4>
                                                </div>
                                                <div id="collapse_{{ $unique_id }}" class="panel-collapse in collapse show" role="tabpanel" aria-labelledby="heading_{{ $unique_id }}" style="">
                                                    <div class="panel-body bg-white">

                                                        <div class="col-12 col-lg-12">
                                                            <div class="col-sm-12 pr-0">
                                                                <div class="form-group">
                                                                    <label for="question"><b>{{ __('question') }}</b></label>
                                                                    <input name="question_id[]" type="hidden" value="{{ $unique_id }}">
                                                                    <input type="text" id="question_input" required class="form-control input-question-text" data-question-id="{{ $unique_id }}" name="question_title[]" placeholder="{{ __('question') }}" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 col-lg-12">
                                                            <div class="row">
                                                                <div class="col-sm-3">
                                                                    <div class="question-image">
                                                                        <div class="form-group">
                                                                            <!-- Large modal -->
                                                                            <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal ml-3" data-id="1" data-toggle="modal" data-question-id="{{ $unique_id }}" data-target=".image-modal-lg">{{ __('add_image') }}</button>
                                                                            <input id="image_id_question_{{ $unique_id }}" name="question_image[]" type="hidden" class="form-control image_id">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <div class="form-group text-center">
                                                                                <img src="{{ static_asset('default-image/default-100x100.png') }} " id="image_preview_question_{{ $unique_id }}" width="200" height="200" alt="image" class="img-responsive img-thumbnail image_preview">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-9">
                                                                    <div class="form-group">
                                                                        <label for="question_content" class="col-form-label pt-0">{{ __('content') }}
                                                                        </label>
                                                                        <textarea name="question_content[]" class="question-content" id="question_content"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <div class="row">
                                                                        <div class="col-sm-12 m-b-15">
                                                                            <label class="control-label">{{ __('answers') }}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="quiz-answers">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 btn-group-answer-formats-container">
                                                                                <input type="hidden" required name="answer_format[]" id="input_answer_format_{{ $unique_id }}" value="small_image">
                                                                                <span class="span-answer-format">{{ __('answer_format') }}</span>
                                                                                <div class="btn-group btn-group-answer-formats" role="group">
                                                                                    <button type="button" class="btn btn-default active btn_{{ $unique_id }}" data-answer-format="small_image" data-question-id="{{ $unique_id }}">
                                                                                        <i class="fa fa-th"></i>
                                                                                    </button>
                                                                                    <button type="button" class="btn btn-default btn_{{ $unique_id }}" data-answer-format="large_image" data-question-id="{{ $unique_id }}">
                                                                                        <i class="fa fa-th-large"></i>
                                                                                    </button>
                                                                                    <button type="button" class="btn btn-default btn_{{ $unique_id }}" data-answer-format="text" data-question-id="{{ $unique_id }}">
                                                                                        <i class="fa fa-th-list"></i>
                                                                                    </button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div id="quiz_answers_container_question_{{ $unique_id }}" class="row row-answer">
                                                                            @php $answer_unique_id = uniqid() @endphp
                                                                            <div id="quiz_answer_{{ $answer_unique_id }}" class="answer">
                                                                                <div class="answer-inner">
                                                                                    <a href="javascript:void(0)" class="btn-delete-answer" onclick="delete_quiz_answer('{{ $answer_unique_id }}')"><i class="fa fa-times"></i></a>
                                                                                    <div class="form-group quiz-answer-image-item-text m-b-0">
                                                                                        ...
                                                                                        <div id="quiz_answer_image_container_answer_{{ $answer_unique_id }}" class="quiz-answer-image-item">
                                                                                            <div class="quiz-answer-image-container" data-question-id="{{ $unique_id }}" data-answer-id="{{ $answer_unique_id }}">
                                                                                                <input type="hidden" name="answer_image_question_{{ $unique_id }}[]" value="" class="image_id">
                                                                                                <a class="btn-select-image btn-image-modal" id="btn_image_modal" data-toggle="modal" data-target=".image-modal-lg" data-id="1" data-quiz-image-type="answer" data-question-id="{{ $unique_id }}" data-answer-id="{{ $answer_unique_id }}">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <textarea required name="answer_text_question_{{ $unique_id }}[]" class="form-control answer-text" placeholder="{{ __('answer_text') }}"></textarea>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-12 text-center">
                                                                                <button type="button" id="btn_add_quiz_answer" class="btn-add-quiz-answer btn btn-add-answer" data-question-id="{{ $unique_id }}" data-question-type="personality_quiz">
                                                                                    <i class="fa fa-plus"></i>{{ __('add_answer') }}
                                                                                </button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div class="row m-3">
                                        <div class="col-sm-12 text-center">
                                            <button type="button" id="btn_add_quiz_question" data-question-number="1" class="btn btn-md btn-primary btn-add-post-item"><i class="fa fa-plus"></i>{{ __('add_question') }}</button>
                                        </div>
                                    </div>
