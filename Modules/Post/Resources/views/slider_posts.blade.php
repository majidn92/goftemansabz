                ...
                <div class="row clearfix m-t-30">
                    <div class="col-12">
                                    ...
                                    <tbody>
                                        @foreach ($posts as $post)
                                            <tr id="row_{{ $post->id }}">
                                                ...
                                                <td width="10%">
                                                    <input type="number" class="form-control btn btn-light" name="order[]" value="{{ $post->slider_order }}">
                                                ...
                                                @if (Sentinel::getUser()->hasAccess(['post_write']))
                                                    <td>
                                                        <a href="javascript:void(0)" onclick="remove_post_form('other','slider','{{ $post->id }}')" name="option" class="btn btn-light active btn-xs">
                        ...
                        @if (Sentinel::getUser()->hasAccess(['post_write']) && $posts->count() > 0)
                            <button type="submit" name="btnSubmit" class="btn btn-primary pull-right"><i class="m-l-10 mdi mdi-content-save-all"></i>{{ __('update_order') }}</button>
                        @endif
                    </div>
                </div>
            </div>
