            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="add-new-page  bg-white p-20 m-b-20">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="post_title" onkeyup="metaTitleSet()" name="title" value="{{ old('title') }}" type="text" class="form-control" required placeholder="تیتر را وارد نمائید">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="row p-l-15">
                                <div class="col-12">
                                    ...
                                    <textarea name="content" value="{{ old('content') }}" id="post_content" cols="30" rows="5" placeholder="متن خبر را وارد نمائید"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- tinemcey end -->
                        ...
                        <div class="row add-new-page  bg-white m-b-20 mx-0" style="padding: 10px">
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="iran" name="iran" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="world" name="world" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="populare" name="populare" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="report" name="report" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="conversation" name="conversation" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="visibility" name="visibility" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 offset-6 p-l-15">
                                <label class="custom-control custom-checkbox pt-1">
                                    <input type="checkbox" id="is_state_post" name="is_state_post" class="custom-control-input">
                                    <span class="custom-control-label"></span>
                            ...
                            <div class="col-sm-6 p-l-15">
                                ...
                                <select name="state_id" class="form-control">
                                    ...
                                    <option value="{{ $state->id }}" @if($state->id == 8 ) selected @endif>{{ $state->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6 p-l-15">
                                ...
                                <select name="section_id" class="form-control">
                                    @foreach ($sections as $section)
                                        <option @if ($section->id == 1) selected @endif value="{{ $section->id }}">{{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="add-new-page  bg-white p-20 m-b-20" id="post_meta">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="meta_title" class="form-control meta" value="" data-type="title" name="meta_title" placeholder="متاتگ عنوان را وارد نمائید">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control meta" id="meta_description" value="" name="meta_description" data-type="description" rows="3" placeholder="متاتگ توضیحات را وارد نمائید"></textarea>
                                    {{-- <p class="display-nothing alert alert-danger mt-2" role="alert">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group" style="margin-bottom: 3px !important">
                                    ...
                                    <input id="post-keywords" name="meta_keywords" value="" type="text" class="form-control" placeholder="کلمات کلیدی را وارد نمائید">
                                </div>
                                <div style="font-size: 13px">کلمات کلیدی را با ویرگول (Shift + T) از هم جدا نمائید</div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group" style="margin-bottom: 3px !important">
                            ...
                            <div class="col-sm-12 text-center">
                                <div class="form-group">
                                    ...
                                    <div id="image_library_selection">
                                        <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal" data-id="0" data-toggle="modal" data-target=".image-modal-lg">افزودن پوستر ویدئو</button>
