...
@section('content')
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!! Form::open(['route' => ['save-new-post', 'audio'], 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9">
                            <div class="add-new-page  bg-white p-20 pb-1" style="margin-bottom: 0 !important">
                                <div class="block-header">
