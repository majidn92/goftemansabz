                        ...
                        <div class="row m-0">
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control example1" id="start_date" name="start_date" value="{{$poll->start_date}}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control example1" id="end_date" name="end_date" value="{{$poll->end_date}}" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group form-float form-group-sm">
                                    <button type="submit" class="btn btn-primary float-right m-t-20"><i
                                            class="m-l-10 mdi mdi-plus"></i>{{ __('update_poll') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
