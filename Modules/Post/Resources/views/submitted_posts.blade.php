                                        ...
                                        <tbody>
                                            @foreach ($posts as $post)
                                                <tr id="row_{{ $post->id }}">
                                                    ...
                                                    <td>{{ miladi_to_jalali($post->created_at) }}</td>
                                                    @if (Sentinel::getUser()->hasAccess(['post_write']))
                                                        <td>
                                                            @if ($post->status == 0)
                                                            ...
                                                            @elseif($post->status == 1)
                                                                <a href="javascript:void(0)" onclick="remove_post_form('index','status','{{ $post->id }}')" name="option" class="btn btn-light active btn-xs">
