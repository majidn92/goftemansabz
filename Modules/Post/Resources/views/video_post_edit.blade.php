                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-9">
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="post_on_title" onkeyup="metaTitleSet()" name="on_title" value="{{ $post->on_title }}" value="{{ old('on_title') }}" type="text" class="form-control" placeholder="رو تیتر را وارد نمائید">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_title" class="col-form-label">{{ __('title') }}*</label>
                                        <input id="post_title" name="title" value="{{ $post->title }}" value="{{ old('title') }}" type="text" class="form-control" required placeholder="تیتر را وارد نمائید">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_sub_title" class="col-form-label">لید خبر</label>
                                        <textarea name="sub_title" id="post_sub_title" cols="30" class="form-control" rows="4" placeholder="لید خبر را وارد نمائید">{{ $post->sub_title }}{{ old('sub_title') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post-slug" class="col-form-label"><b>{{ __('slug') }}</b></label>
                                        <input id="post-slug" value="{{ $post->slug }}" name="slug" type="text" class="form-control" placeholder="نامک را وارد نمائید">
                                    </div>
                                </div>
                                <!-- tinemcey start -->
                            ...
                            <div class="row add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-6 p-l-15 pt-1">
                                    <label class="custom-control custom-checkbox pt-1">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <label for="populare">پربیننده</label>
                                    </label>
                                </div>
                                <div class="col-sm-6 p-l-15 pt-1">
                                    <label class="custom-control custom-checkbox pt-1">
                                ...
                                <div class="col-sm-6 p-l-15 pt-1">
                                    <label class="custom-control custom-checkbox pt-1">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <label for="conversation">گفتگو</label>
                                    </label>
                                </div>
                                <div class="col-sm-6 p-l-15">
                                    <label class="custom-control custom-checkbox pt-1">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <label for="visibility">عدم نمایش</label>
                                    </label>
                                </div>
                                <div class="col-sm-6 offset-6 p-l-15">
                                    <label class="custom-control custom-checkbox pt-1">
                                        ...
                                        <span class="custom-control-label"></span>
                                        <label for="is_state_post">افزودن به اخبار استان ها</label>
                                    </label>
                                </div>
                                <div class="col-sm-6 p-l-15">
                                    @php
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="meta_title"><b>متاتگ عنوان</b></label>
                                        <input class="form-control meta" value="{{ $post->meta_title ?? $post->title }}" id="meta_title" name="meta_title" data-type="title" placeholder="متاتگ عنوان را وارد نمائید">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_desc"><b>متاتگ توضیحات</b></label>
                                        <textarea class="form-control meta" id="meta_description" name="meta_description" data-type="description" rows="3" placeholder="متاتگ توضیحات را وارد نمائید">{{ $post->meta_description }}</textarea>
                                        {{-- <p class="display-nothing alert alert-danger mt-2" role="alert">
                                            {{ __('current_characters') }}: <span class="characters"></span>, {{ __('meta_title') . ' ' . __('should_bd') . ' ' . __('in_between') . ' ' . '30-60 ' . __('characters') }}
                                        </p>
                                        <p class="display-nothing alert alert-success mt-2" role="alert">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="post-keywords" name="meta_keywords" value="{{ $post->meta_keywords }}" type="text" class="form-control" placeholder="کلمات کلیدی را وارد نمائید">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="post_tags" class="col-form-label"><b>{{ __('tags') }}</b></label>
                                        <input id="post_tags" name="tags" type="text" value="{{ $post->tags }}" data-role="tagsinput" class="form-control"  placeholder="برچسب ها را وارد نمائید">
                                    </div>
                                </div>
                            </div>
                            <!-- SEO section end -->
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="add-video-tab">
                                    <nav>
                                        <div class="nav nav-tabs m-b-20" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link @if ($post->video_id != null) active @endif" id="upload-video-file" data-toggle="tab" href="#upload-video" role="tab">{{ __('upload_video') }}</a>
                                            <a class="nav-item nav-link @if ($post->video_id == null) active @endif" id="video-link" data-toggle="tab" href="#video_by_link" role="tab">{{ __('remove_video') }}</a>
                                        </div>
                                    </nav>

                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade @if ($post->video_id != null) show active @endif" id="upload-video" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group text-center">
                                                        ...
                                                        <input id="video_id" value="{{ $post->video_id }}" name="video_id" type="hidden" class="form-control video_id">
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="col-sm-12">
                                                    <div class="form-group text-center">
                                                        @if (isFileExist($post->video, @$post->video->video_thumbnail))
                                                            <img src="{{ basePath($post->video) }}/{{ $post->video->video_thumbnail }} " id="video_thumb" width="200" height="200" alt="image" class="img-responsive img-thumbnail video_preview" style="display:inline">
                                                        @else
                                                            <img id="video_thumb" src="{{ static_asset('default-image/default-video-100x100.png') }} " id="image_preview" width="200" height="200" alt="image" class="img-responsive img-thumbnail video_preview">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <hr>
                                        <div class="tab-pane fade  @if ($post->video_id == null) show active @endif" id="video_by_link" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="video_url_type" name="video_url_type" class="form-control">
                                                            ...
                                                            <option @if ($post->video_url_type == 'mp4_url') selected @endif value="mp4_url">MP4 url
                                                            </option>
                                                            <option @if ($post->video_url_type == 'youtube_url') selected @endif value="youtube_url">Youtube url
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="video_url" value="{{ $post->video_url }}" name="video_url" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group text-center">
                                    <!-- Large modal -->
                                    <button type="button" class="btn btn-primary btn-image-modal" data-id="2" data-toggle="modal" data-target=".image-modal-lg">افزودن تبلیغ ویدئو</button>
                                    <input id="video_thumbnail_id" value="{{ $post->video_thumbnail_id }}" name="video_thumbnail_id" type="hidden" class="form-control image_id">
                                </div>
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        @if ($post->post_type == 'video')
                                            @if (isFileExist(@$post->videoThumbnail, $result = @$post->videoThumbnail->thumbnail))
                                                <img src=" {{ basePath($post->videoThumbnail) }}/{{ $result }}" id="video_thumb_preview" width="200" height="200" alt="{!! $post->title !!}" class="img-responsive img-thumbnail image_preview">
                                            @else
                                                <img src="{{ static_asset('default-image/default-100x100.png') }} " id="video_thumb_preview" width="200" height="200" alt="{!! $post->title !!}" class="img-responsive img-thumbnail image_preview">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                <div class="col-sm-12">
                                    <div class="form-group text-center">
                                        <!-- Large modal -->
                                        <button type="button" id="btn_image_modal" class="btn btn-primary btn-image-modal" data-id="1" data-toggle="modal" data-target=".image-modal-lg">افزودن پوستر ویدئو</button>
                            ...
                            <div class="add-new-page  bg-white p-20 p-0">
                                <div class="col-md-12">
