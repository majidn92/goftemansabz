                                    ...
                                    <div class="col-12 m-t-20">
                                        <div class="form-group form-float form-group-sm text-right">
                                            <button type="submit" name="status" value="1" class="btn btn-primary pull-right">
                                                <i class="m-l-10 mdi mdi-content-save-all"></i>{{ __('save')}}
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @if(Sentinel::getUser()->hasAccess(['language_settings_write']))
                                <div class="add-new-page  bg-white p-20 m-b-20">
                                    ...
                                    <div class="row p-l-15">
                                        ...
                                        <div class="col-md-4">
                                            <label class="custom-control custom-radio custom-control-inline pl-0">
                                        ...
                                        <div class="col-12 m-t-20">
                                            <div class="form-group form-float form-group-sm text-right">
                                                <button type="submit"
                                                        ...
                                                        class="m-l-10 mdi mdi-plus"></i>{{ __('add_language') }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="block-header">
                                            <h2>{{ __('showing')}} {{ $languages->firstItem()}} {{ __('to') }} {{ $languages->lastItem()}}
                                                از {{ $languages->total()}} {{ __('entries') }}</h2>
                                        </div>
                                    </div>
