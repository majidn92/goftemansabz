                        ...
                        <div class="add-new-page  bg-white p-0 m-b-20">
                            ...
                            <nav>
                                <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link active" id="general-settings" href="{{ route('setting-general') }}" role="tab">{{ __('general_settings') }}</a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="default_language" id="settings_language">
                                        ...
                                        <div class="col-sm-12" style="margin: 5px 0px;">
                                            <div class="row m-0" style="border: 1px solid #ccc;padding-top: 3em;padding-bottom: 2em">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label for="logo" class="upload-file-btn btn btn-primary"><i class="fa fa-folder input-file" aria-hidden="true"></i> {{ __('add_logo')}}</label>
                                                        <input id="logo" name="logo" onChange="swapImage(this)" data-index="0" type="file" class="form-control d-none" accept="image/*">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group text-center">
                                                        @if(settingHelper('logo') != Null)
                                                        <img src="{{ static_asset(settingHelper('logo')) }}" data-index="0" height="64" width="auto" alt="img">
                                                        @else
                                                        <img src="{{static_asset('default-image/default-100x100.png') }}" height="64" width="auto" data-index="0" alt="user" class="img-responsive ">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12" style="margin: 5px 0px;">
                                            <div class="row m-0" style="border: 1px solid #ccc;padding-top: 3em;padding-bottom: 2em">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label for="favicon" class="upload-file-btn btn btn-primary"><i class="fa fa-folder input-file" aria-hidden="true"></i> {{ __('add_favicon')}}</label>

                                                        <input id="favicon" name="favicon" onChange="swapImage(this)" data-index="1" type="file" class="form-control d-none" accept="image/*">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group text-center">
                                                        @if(settingHelper('favicon') != Null)
                                                        <img src="{{ static_asset(settingHelper('favicon')) }}" data-index="1" height="64" width="auto" alt="img">
                                                        @else
                                                        <img src="{{static_asset('default-image/default-100x100.png') }}" height="64" width="auto" data-index="1" alt="user" class="img-responsive ">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
