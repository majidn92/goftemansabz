                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input name="url" value="{{ $section->url }}" value="{{ old('url') }}" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3 offset-sm-9 p-l-15">
                        <label class="custom-control custom-checkbox pt-1">
                            <input type="checkbox" id="show" name="show" class="custom-control-input" @if ($section->show) checked @endif>
                            <span class="custom-control-label"></span>
                            <label>نمایش</label>
                        </label>
                    </div>
                    <div class="col-sm-3 p-l-15 option" @if ($section->show == 0) style="display:none" @endif>
                        <label class="custom-control custom-checkbox pt-1">
                            <input type="checkbox" id="slider" name="slider" class="custom-control-input" @if ($section->slider) checked @endif>
                            <span class="custom-control-label"></span>
                    ...
                    <div class="col-sm-3 p-l-15 option" @if ($section->show == 0) style="display:none" @endif>
                        <label class="custom-control custom-checkbox pt-1">
                            <input type="checkbox" id="last_post" name="last_post" class="custom-control-input" @if ($section->last_post) checked @endif>
                            <span class="custom-control-label"></span>
                    ...
                    <div class="col-sm-3 p-l-15 option" @if ($section->show == 0) style="display:none" @endif>
                        <label class="custom-control custom-checkbox pt-1">
                            <input type="checkbox" id="video" name="video" class="custom-control-input" @if ($section->video) checked @endif>
                            <span class="custom-control-label"></span>
                    ...
                    <div class="col-sm-3 p-l-15 option" @if ($section->show == 0) style="display:none" @endif>
                        <label class="custom-control custom-checkbox pt-1">
                            <input type="checkbox" id="ads" name="ads" class="custom-control-input" @if ($section->ads) checked @endif>
                            <span class="custom-control-label"></span>
