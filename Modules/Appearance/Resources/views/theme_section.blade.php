                                        ...
                                        <div class="row">
                                            <div class="col-12 m-t-20">
                                                <div class="form-group form-float form-group-sm text-right">
                                                    <button type="submit" name="btnsubmit" class="btn btn-primary pull-right"><i class="m-l-10 mdi mdi-content-save-all"></i>{{ __('save') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <input type="hidden" name="sections[]" value="{{$section->id}}">
                                                            <tr role="row" class="odd" id="row_{{ $section->id }}">
                                                                ...
                                                                <td>{{ $section->ad->ad_name ?? __('no') }}</td>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="block-header">
                                                        <h2>{{ __('showing')}} {{ $sections->firstItem()}} {{ __('to') }} {{ $sections->lastItem()}}
                                                            از {{ $sections->total()}} {{ __('entries') }}</h2>
                                                    </div>
                                                </div>
