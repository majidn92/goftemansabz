    ...
    <div class="ragister-account text-center">
        <div class="container">
            <div class="account-content">
                <h1>بازیابی رمز عبور</h1> {{-- @include('site.partials.error') --}}
                <form class="ragister-form" name="ragister-form" method="post" action="{{route('do-forget-password')}}">
                    @csrf
                    <div class="form-group text-left mb-0">
                        <input name="email" type="email" value="{{old('email')}}" class="form-control" required="required" placeholder="ایمیل خود را وارد نمائید" autocomplete="off">
                    </div>
