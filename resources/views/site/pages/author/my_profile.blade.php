        ...
        <div class="author-content">
            <div class="author-top-content d-md-flex">
                <div class="author">
                    ...
                    <img src="{{static_asset('default-image/user.jpg') }}" data-original=" {{static_asset(Sentinel::getUser()->profile_image)}}" id="profile-img" class="img-fluid">
                    @else
                ...
                <div class="author-info">
                    ...
                    <div class="active">
                        <span>{{ __('last_login') }}: {{ ago_time(Sentinel::getUser()->last_login) }}</span>
                    </div>
                    ...
                    <div class="entry-meta">
                        <ul class="global-list">
                            <li>
                                <i class="fa fa-birthday-cake" aria-hidden="true"></i> <a href="#">{{ miladi_to_jalali(Sentinel::getUser()->dob) }}</a>
                            </li>
                    ...
                    <div class="entry-meta">
                        <ul class="global-list">
                            <li>
                                <a href="#">{{ __('member_since') }}: {{ miladi_to_jalali(Sentinel::getUser()->created_at) }}</a>
                            </li>
                    ...
                    <div class="sg-social">
                        <ul class="global-list d-flex">
                            ...
                            <li><a href="{{ @Sentinel::getUser()->social_media['facebook_url'] }}"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['twitter_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['twitter_url'] }}"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['instagram_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['instagram_url'] }}"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['google_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['google_url'] }}"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['pinterest_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['pinterest_url'] }}"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['youtube_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['youtube_url'] }}"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                            @endif
                            @if(@Sentinel::getUser()->social_media['linkedin_url'] != null)
                            <li><a href="{{ @Sentinel::getUser()->social_media['linkedin_url'] }}"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            @endif
                        </ul>
                    </div><!-- /.sg-social -->
                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="sg-post">
                                ...
                                <div class="entry-content">
                                    <h3 class="entry-title"><a href="{{ route('article.detail', ['id' => $post->slug]) }}">
                                            <p>{!! \Illuminate\Support\Str::limit($post->title, 50) !!}</p>
                                        </a>
                                    </h3>
