...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ static_asset('favicon.ico') }}">
                ...
                <script type="application/ld+json">
                    {
                        ...
                        "image": "{{ url($post->image->small_image) }}",
                        "articleSection": "{{ $post->category->category_name }}",
                        "url": "{{ url('story') . '/' . $post->slug }}",
                        "publisher": {
                            "@type": "Organization",
                            "name": "گفتمان سبز"
                        },
...
<body class="{{ defaultModeCheck() }}">
    ...
    @if (settingHelper('preloader_option') == 1)
        <div id="preloader">
            <img src="{{ static_asset('site/images/preloader.gif') }}" alt="Image" class="tr-preloader img-fluid">
        </div>
    @endif
